...
* Choose to make plugin work everywhere on the site or only on the profile page.
* If user is not enrolled in the course (or has completed it), course link will not be changed.


== Installation ==
1. Upload plugin folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the "Plugins" menu in WordPress.
3. Visit settings through "Next Step" (LearnDash - LMS submenu) link.
